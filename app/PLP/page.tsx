...
function PageContent() {
  ...
  if (!data || data.length === 0) {
    return (
      <div className="mx-auto container align-middle text-center mt-30 h-screen text-2xl pt-20 font-bold">
        No products found! Go to <Link href='/' className="text-blue-600 underline">Home</Link>
        <Image
          src="https://img.freepik.com/free-vector/error-404-concept-illustration_114360-1811.jpg?t=st=1739354976~exp=1739358576~hmac=d35aa84c4244bcf0e4bc0fc75f55470cfc93d5efbacb9985f517b69cba429df0&w=1800"
          width={700}
          height={500}
          className="ml-[270px]"
          alt="images"
