...
<Link href="/ProductPage" className="text-black font-bold ml-2 bg-yellow-500 p-3  rounded-lg  hover:p-4">Shop New  products</Link>
  ...
  return (
    <div className="mx-auto container justify-center align-middle">
            <Link className="bg-blue-400 p-3 rounded-2xl w-25 " href="/">
        Back
      </Link>
      <h1 className="justify-center align-middle flex text-3xl text-black font-bold ">
        Your Wishlist items
      </h1>
